...
public class Menu {
    ...
    public native void Init(Context context, TextView title, TextView subTitle);
...
//        wView.getSettings().setAppCacheEnabled(true);
    ...
    private void Switch(LinearLayout linLayout, final int featNum, final String featName, boolean swiOn) {
        ...
        switchR.setOnCheckedChangeListener((compoundButton, bool) -> {
            int ret = Preferences.changeFeatureBool(featName, featNum, bool);
...
//        wView.getSettings().setAppCacheEnabled(false);   // compileSdk 32
        wView.getSettings().setAllowContentAccess(true);
        wView.getSettings().setAllowFileAccess(true);
